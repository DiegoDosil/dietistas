        ...
        <select class="js-example-basic-single" id="id_dieta" name="id_dieta">
       	@foreach ($dietas as $dieta)
       		@if($dieta->dietista_id === $_SESSION['id'])
                 ...
                 <option value="{{ $dieta->id }}">INCOMPLETA - {{ $dieta->nome }} @if($dieta->observacions!=null) - {{ $dieta->observacions }} @endif</option>
                @else
				 <option value="{{ $dieta->id }}">COMPLETA - {{ $dieta->nome }} @if($dieta->observacions!=null) - {{ $dieta->observacions }} @endif</option>
                @endif
            @endif
        @endforeach
        </select>
