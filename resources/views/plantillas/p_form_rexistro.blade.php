...
<form method="POST">
    ...
    <div class="form-group">
        <p>Teléfono: <input type="number" name="telefono" class="form-control" id="telefono"  value="{{ old('telefono') }}" placeholder="Introduza número de teléfono" required></p>
    </div>
    <input id="idasociado" type="hidden" name="idasociado" value="{{$slot}}">
    <input id="activado" type="hidden" name="activado" value="si">
